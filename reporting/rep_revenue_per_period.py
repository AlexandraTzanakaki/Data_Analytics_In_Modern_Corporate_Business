...
table_id = 'rep_revenue_per_period_table' # Modify the necessary table name: stg_customer, stg_city etc.
...
with base as (
  select *
  from `dat-ana-in-mod-corp-busin-2026.reporting_db.rep_revenue_per_period_table` --Your table path
  )

  , final as (
    select

         reporting_period as rep_revenue_per_period_reporting_period
        , reporting_date as rep_revenue_per_period_reporting_date
        , total_revenue as rep_revenue_per_period_total_revenue
...
schema = [
    bigquery.SchemaField('rep_revenue_per_period_reporting_period', 'STRING'),
    bigquery.SchemaField('rep_revenue_per_period_reporting_date', 'DATETIME'),
    bigquery.SchemaField('rep_revenue_per_period_total_revenue', 'NUMERIC'),
