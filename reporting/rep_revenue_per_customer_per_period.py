...
with base as (
  select *
  from `dat-ana-in-mod-corp-busin-2026.reporting_db.rep_revenue_per_customer_per_period_table` --Your table path
  )

  , final as (
    select

         reporting_period as rep_revenue_per_customer_per_period_reporting_period
        , reporting_date as rep_revenue_per_customer_per_period_reporting_date
        , total_revenue as rep_revenue_per_customer_per_period_total_revenue
        , customer_id as rep_revenue_per_customer_per_period_customer_id
...
schema = [
    bigquery.SchemaField('rep_revenue_per_customer_per_period_reporting_period', 'STRING'),
    bigquery.SchemaField('rep_revenue_per_customer_per_period_reporting_date', 'DATETIME'),
    bigquery.SchemaField('rep_revenue_per_customer_per_period_total_revenue', 'NUMERIC'),
    bigquery.SchemaField('rep_revenue_per_customer_per_period_customer_id', 'INTEGER'),
