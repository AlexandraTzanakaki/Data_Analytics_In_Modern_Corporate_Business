...
with base as (
  select *
  from `dat-ana-in-mod-corp-busin-2026.pagila_productionpublic.film_actor` --Your table path
  )

  , final as (
    select
        actor_id
        , film_id as actor_film_id
...
schema = [
    ...
    bigquery.SchemaField('actor_film_id', 'INTEGER'),
